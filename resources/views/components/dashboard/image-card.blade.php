      ...
      <div class="flex items-center space-x-3">
        ...
        <div class="flex-shrink-0">
          <img
            ...
            src="{{$ifProfile===true?asset('/storage/profile/'.$profile->image):asset('/img/profile.jpeg')}}"
            alt="Al Nahian" />
        </div>
        <!-- /User Avatar -->
        ...
        <div class="text-gray-900 flex flex-col min-w-0 flex-1">
          ...
          <a
            href="{{$ifProfile===true?url("/FindUser/{$profile->user->id}"):''}}"
            class="hover:underline font-semibold line-clamp-1">
             {{$ifProfile===true?$profile->user->fname:''}}
          </a>

          <a
            href="https://twitter.com/alnahian2003"
            class="hover:underline text-sm text-gray-500 line-clamp-1">
            {{$ifProfile===true?$profile->user->uname:''}}
          </a>
        </div>
        <!-- /User Info -->
      </div>
